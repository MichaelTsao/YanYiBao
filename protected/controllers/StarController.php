...
class StarController extends Controller
{
	...
	{
		$model=new Star('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Star']))
			$model->attributes=$_GET['Star'];
	 ...
	 * @param Star $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='star-form')
		{
